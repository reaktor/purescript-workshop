...
import HackerNewsApi (Story, fetchHackerNewsStories)
import Halogen as H
...
loadHackerNewsStories :: Aff _ (Array Story)
...
main = HA.runHalogenAff do
  stories <- loadHackerNewsStories
  body <- HA.awaitBody
  runUI (appComponent stories) unit body
